#ifndef SDL_GPU_SPIRVCROSS_H
#define SDL_GPU_SPIRVCROSS_H
...
#endif /* SDL_GPU_SPIRVCROSS_H */

#ifdef SDL_GPU_SPIRVCROSS_IMPLEMENTATION
...
#endif /* SDL_GPU_SPIRVCROSS_IMPLEMENTATION */
